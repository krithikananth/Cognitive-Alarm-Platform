 ...
 *
 * Sources: `sleep_schedule_adherence`, `wake_up_consistency`, `habit_trends`,
 * and `window_trends` from GET /coach/clients/{id}/behavioral. `window_trends`
 * spans exactly the selected window, so the charts move with the period chips.
 */
